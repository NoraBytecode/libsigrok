...
#define LIBSIGROK_HARDWARE_UNI_T_MSO2_PROTOCOL_H
...
struct uni_t_mso2_vendor {
	const char *name;
	const char *full_name;
};

struct uni_t_mso2_series {
	const struct uni_t_mso2_vendor *vendor;
	const char *name;
...
struct uni_t_mso2_command {
	int cmd;
	const char *str;
};

struct uni_t_mso2_model {
	const struct uni_t_mso2_series *series;
	const char *name;
	...
	const struct uni_t_mso2_command *cmds;
};
...
struct dev_context {
	const struct uni_t_mso2_model *model;
	enum data_format format;
